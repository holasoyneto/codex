  ...
  function TimelinePanel(ctx) {
    ...
    const renderedMarkers = useMemo(() => {
      ...
      for (const [k, list] of buckets) {
        if (list.length === 1) out.push({ kind: "event", ev: list[0] });else
        out.push({ kind: "bucket", year: k + bucketSize / 2, list });
      }
      return out;
    }, [filtered, zoom]);
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-tl-root" }, /*#__PURE__*/

      React.createElement("div", { className: "cx-tl-head" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-title" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-tl-title-main" }, "Biblical Timeline"), /*#__PURE__*/
      React.createElement("span", { className: "cx-tl-title-meta" }, filtered.length, " events")
      ), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-controls" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-zoom", role: "tablist", "aria-label": "Timeline zoom" },
      ["era", "century", "detail"].map((z) => /*#__PURE__*/
      React.createElement("button", { key: z,
        className: "cx-tl-zoom-btn" + (zoom === z ? " is-on" : ""),
        onClick: () => setZoom(z),
        "aria-pressed": zoom === z }, z.toUpperCase())
      )
      ), /*#__PURE__*/
      ...
      React.createElement(IntelBanner, { console: "TIMELINE", scope: "CHRONOLOGY" }), /*#__PURE__*/


      React.createElement("div", { className: "cx-tl-chips" },
      CATEGORIES.map((c) => {
        ...
        return (/*#__PURE__*/
          React.createElement("button", { key: c.id,
            ...
            "aria-pressed": on,
            title: c.label }, /*#__PURE__*/
          React.createElement("span", { className: "cx-tl-chip-glyph" }, c.glyph), /*#__PURE__*/
          React.createElement("span", { className: "cx-tl-chip-lbl" }, c.label)
          ));
      ...
      React.createElement("div", { className: "cx-tl-scroll", ref: scrollRef }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-track", ref: trackRef, style: { width: totalW + "px" } }, /*#__PURE__*/

      React.createElement("div", { className: "cx-tl-bands" },
      eraBands.map((b) => /*#__PURE__*/
      React.createElement("div", { key: b.era.id,
      ...
      React.createElement("span", { className: "cx-tl-band-label" }, b.era.label)
      )
      )
      ), /*#__PURE__*/


      React.createElement("div", { className: "cx-tl-axis" }), /*#__PURE__*/


      React.createElement("div", { className: "cx-tl-ticks" },
      ticks.map((y) => /*#__PURE__*/
      React.createElement("div", { key: y, className: "cx-tl-tick", style: { left: yearToX(y) + "px" } }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tick-mark" }), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tick-lbl" }, yearLabel(y))
      )
      )
      ), /*#__PURE__*/


      React.createElement("div", { className: "cx-tl-markers" },
      renderedMarkers.map((m, i) => {
        if (m.kind === "bucket") {
          return (/*#__PURE__*/
            React.createElement("button", { key: "b" + i,
              className: "cx-tl-bucket",
              style: { left: yearToX(m.year) + "px" },
              onClick: () => {setZoom("detail");setSelected(m.list[0]);},
              title: `${m.list.length} events near ${yearLabel(Math.round(m.year))}` }, /*#__PURE__*/
            React.createElement("span", { className: "cx-tl-bucket-n" }, m.list.length)
            ));
        ...
        return (/*#__PURE__*/
          React.createElement("button", {
            ...
            "aria-label": `${e.title} (${yearLabel(e.year)})` }, /*#__PURE__*/
          React.createElement("span", { className: "cx-tl-mark-stem", style: { background: era ? era.tint : "var(--cx-fg-dim)" } }), /*#__PURE__*/
          React.createElement("span", { className: "cx-tl-mark-dot", style: { background: era ? era.tint : "var(--cx-fg)" } },
          cat ? cat.glyph : "●"
          ),
          zoom === "detail" && /*#__PURE__*/
          React.createElement("span", { className: "cx-tl-mark-lbl" }, e.title)
      ...
      hover && /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tip",
        style: { left: yearToX(hover.year) + "px" } }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tip-title" }, hover.title), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tip-year" }, yearLabel(hover.year)), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-tip-sum" }, hover.summary)
      )
      ...
      selected ? /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-head" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-era",
      ...
      React.createElement("div", { className: "cx-tl-detail-cat" },
      (CAT_LOOKUP[selected.category] || {}).glyph, " ", (CAT_LOOKUP[selected.category] || { label: selected.category }).label
      ), /*#__PURE__*/
      React.createElement("button", { className: "cx-tl-detail-x", onClick: () => setSelected(null), "aria-label": "Close" }, "\u2715")
      ), /*#__PURE__*/
      React.createElement("h3", { className: "cx-tl-detail-title" }, selected.title), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-year" }, yearLabel(selected.year),
      selected.year_range && selected.year_range[0] !== selected.year_range[1] ? /*#__PURE__*/
      React.createElement("span", { className: "cx-tl-detail-range" }, " \xB7 range ", yearLabel(selected.year_range[0]), " \u2013 ", yearLabel(selected.year_range[1])) :
      null
      ), /*#__PURE__*/
      React.createElement("p", { className: "cx-tl-detail-sum" }, selected.summary),
      selected.scripture && selected.scripture.length > 0 && /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-refs" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-refs-h" }, "Scripture"), /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-refs-list" },
      selected.scripture.map((r, i) => {
        const p = parseScriptureRef(r);
        if (!p) return null;
        return (/*#__PURE__*/
          React.createElement("button", { key: i, className: "cx-tl-ref",
            onClick: () => onJumpRef(r) }, p.display));

      })
      )
      ),

      selected.people && selected.people.length > 0 && /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-meta" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-tl-detail-meta-h" }, "People:"), " ",
      selected.people.join(", ")
      ),

      selected.places && selected.places.length > 0 && /*#__PURE__*/
      React.createElement("div", { className: "cx-tl-detail-meta" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-tl-detail-meta-h" }, "Places:"), " ",
      selected.places.join(", ")
      )

      ) : /*#__PURE__*/

      React.createElement("div", { className: "cx-tl-hint" }, "Click any marker to see the event. Use the zoom buttons to widen or compress the axis. Events tied to your current passage glow."
