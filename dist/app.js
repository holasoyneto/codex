...
function App() {
  ...
  useEffect(() => {
    window.codexDeskPanels = {
      ...
      toggle: (id) => {
        if (!BUILTIN_WIN[id]) return;
        if (deskPanels.includes(id)) closeBuiltinPanel(id);else
        openBuiltinPanel(id);
      }
    };
  ...
  return (/*#__PURE__*/
    ...
    (() => {
      ...
      window.CodexReaderX ?
      React.createElement(window.CodexReaderX, { surface: "main" }) : /*#__PURE__*/
      ...
      if (deskMode) {
        ...
        return (/*#__PURE__*/
          ...
          deskPanels.map((pid) => BUILTIN_WIN[pid] ? /*#__PURE__*/
          React.createElement(DeskWin, {
            key: pid,
            id: `builtin:${pid}`,
